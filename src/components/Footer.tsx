        ...
        <div className="grid gap-8 md:grid-cols-4">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li><Link to="/design" className="hover:text-foreground transition-colors">Design Studio</Link></li>
            </ul>
          </div>
          <div>
          ...
          <div>
            <h4 className="mb-3 font-display text-sm font-semibold">Created By</h4>
            <ul className="space-y-2 text-sm text-muted-foreground">
