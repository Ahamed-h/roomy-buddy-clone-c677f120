  ...
  return (
    <>
      ...
      <Grid
        ...
        position={[0, 0.001, 0]}
        cellSize={0.5}
        cellColor="hsl(220,15%,20%)"
        sectionSize={2}
        sectionColor="hsl(220,15%,25%)"
        fadeDistance={12}
        fadeStrength={1}
      />
      {furniture.map((item) => (
                ...
                <div className="p-3 space-y-3">
                  ...
                  >
                    ...
                    <input ref={fileInputRef} type="file" accept="image/*" className="hidden" onChange={() => {
                      toast({ title: "Photo-to-3D", description: "Connect Lovable Cloud to enable AI furniture extraction." });
                    }} />
                  </div>
            ...
            <TabsContent value="market" className="flex-1 overflow-hidden">
              <ScrollArea className="h-full studio-scrollbar">
                <div className="p-3 space-y-3">
                  ...
                  <p className="text-center text-[10px] text-studio-text-muted">
                    Every store, zero markup
                  </p>
